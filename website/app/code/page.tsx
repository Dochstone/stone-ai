...
const modelDescriptions: Record<string, string> = {
  ...
  "devstral": "Специализированная модель для кода от Mistral. Доступна от тарифа Start.",
...
const bcJsonLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Главная", item: `${SITE_URL}/` }, { "@type": "ListItem", position: 2, name: "AI Код", item: `${SITE_URL}/code` }] };
