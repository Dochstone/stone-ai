...
export const metadata: Metadata = {
  ...
  title: {
    default: "AI-студия нового поколения — 65+ нейросетей, 15 инструментов | Stone AI",
    template: "%s | Stone AI",
  },
  description:
    "Stone AI — AI-студия нового поколения. 65+ нейросетей, 15 инструментов: чат, картинки, видео, реклама, SEO, презентации, боты и агенты. Создавай, продвигай, автоматизируй. Оплата в рублях.",
  keywords: [
    "AI чат",
...
const jsonLdSoftware = {
  ...
  offers: {
    ...
    priceCurrency: "USD",
    offerCount: "50",
    description: "Бесплатный старт — 10 запросов в день. Подписка от 590₽/мес. Free / Start / Pro / Elite.",
  },
};
