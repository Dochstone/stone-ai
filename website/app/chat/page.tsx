...
const faqItems = [
  ...
  },
  {
    ...
    a: "Free — 15 запросов в день к 7 моделям. Start (390₽/мес) — 500 запросов/мес к быстрым + 20 к премиум. Pro (890₽/мес) — 2 000 + 100. Elite (1990₽/мес) — 10 000 + 500. Все тарифы на странице /pricing.",
  },
];
