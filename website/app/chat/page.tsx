...
const faqItems = [
  ...
  },
  {
    ...
    a: "Зависит от модели и длины сообщений. Бесплатные модели (GPT-4o mini, Claude Haiku) — 10 запросов в день. Платные: GPT-4o mini через per-token от $0.004, Claude Opus от $0.20. После каждого запроса видно точную стоимость.",
  },
];
...
export default function ChatPage() {
  return (
    <>
      ...
      <ToolCta title="Начните общаться с AI" subtitle="5 моделей бесплатно, 10 запросов в день. Без VPN и регистрации." />
    </>
  );
}
