...
const modelDescriptions: Record<string, string> = {
  "perplexity-sonar-pro": "Продвинутый поиск с глубоким анализом. Ищет в реальном времени, даёт источники.",
  "perplexity-sonar-deep": "Deep Research — автоматические исследования на 20+ страниц. Идеален для аналитики.",
  "perplexity-sonar": "Базовый AI-поиск. Быстрые ответы с актуальными данными и ссылками.",
};
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Stone AI даёт удобный доступ к Perplexity через привычный Telegram. Оплата в рублях через Stars, крипту или TON. Плюс все остальные 65+ нейросетей и 15 инструментов.",
  },
];
...
const bcJsonLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Главная", item: `${SITE_URL}/` }, { "@type": "ListItem", position: 2, name: "AI Поиск", item: `${SITE_URL}/search` }] };
