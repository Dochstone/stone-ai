...
export default function ProfessionPage({ params }: Props) {
  ...
  const benefitsMap: Record<string, string[]> = {
    ...
    student: ["15 бесплатных запросов каждый день", "Пошаговое объяснение сложных тем", "Помощь с математикой и программированием", "Генерация конспектов и планов работ", "Подготовка к экзаменам с AI-тренажёром", "Перевод и работа с иностранными текстами"],
  };
  ...
  const faqItemsMap: Record<string, { q: string; a: string }[]> = {
    marketer: [
      ...
      { q: "Можно ли использовать бесплатно?", a: "Да, 15 бесплатных запросов в день к 8 моделям. Для генерации изображений — 2 бесплатные генерации. Без привязки карты." },
    ...
    developer: [
      ...
      { q: "Можно ли использовать бесплатно?", a: "Да, 15 бесплатных запросов в день. Бесплатные модели: GPT-4o mini, Claude Haiku, Gemini Flash, DeepSeek V3, Llama 4 — все подходят для кода." },
    ...
    copywriter: [
      ...
      { q: "Можно ли использовать бесплатно?", a: "Да, 15 бесплатных запросов в день к 8 моделям. Для большинства задач копирайтера хватает GPT-4o mini (бесплатный) — он хорошо пишет на русском." },
    ...
    designer: [
      ...
      { q: "Можно ли использовать бесплатно?", a: "Да, 2 бесплатные генерации изображений для новых пользователей. Для текстовых задач (описание концептов) — 15 бесплатных запросов в день." },
    ...
    student: [
      { q: "Это действительно бесплатно?", a: "Да, 15 бесплатных запросов каждый день к 8 моделям: GPT-4o mini, Claude Haiku, Gemini Flash, DeepSeek V3, Llama 4 и другие. Без привязки карты, без подписки." },
