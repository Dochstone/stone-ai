...
curl "${BASE_URL}/api/models?category=image"   # по категории`} />
  ...
  "content": "Извлечённый текст из PDF..."
            ...
            <Section id="billing" title="Биллинг">
              <P>Stone AI использует систему подписок: Free (0₽), Start (590₽/мес), Pro (1290₽/мес), Elite (2990₽/мес). Лимиты запросов зависят от тарифа.</P>
            ...
            <Section id="limits" title="Лимиты">
              <Table
                ...
                rows={[
                  ["Free", "10", "2/день", "—", "2 пробных", "2 пробных (lifetime)"],
