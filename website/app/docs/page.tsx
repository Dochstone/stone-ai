...
curl "${BASE_URL}/api/models?category=image"   # по категории`} />
  ...
  "content": "Извлечённый текст из PDF..."
            ...
            <Section id="billing" title="Биллинг">
              <P>Stone AI использует систему подписок: Free (0₽), Start (590₽/мес), Pro (890₽/мес), Elite (1990₽/мес). Лимиты запросов зависят от тарифа.</P>
              ...
              />
              <P>7 моделей бесплатно (10 запросов/день). Остальные — по подписке Start/Pro/Elite.</P>
