...
export default function ToolHubPage({ params }: Props) {
  ...
  const baseFaqItems = [
    { q: `Сколько стоит ${hub.category.toLowerCase()}?`, a: "15 бесплатных запросов/день к текстовым моделям. Для генерации изображений — 2 бесплатные генерации. Подписки от 590₽/мес с доступом ко всем 65+ моделям." },
    ...
    { q: "Нужна ли регистрация?", a: "Первые 2 запроса — без регистрации. Далее бесплатная регистрация (15 запросов/день). Без привязки карты." },
  ];
