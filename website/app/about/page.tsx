...
export const metadata: Metadata = {
  ...
  description:
    "Stone AI — российская платформа доступа к 50+ нейросетям. Узнайте о нашей команде, миссии и технологиях. Работаем с 2025 года.",
...
const values = [
  {
    ...
    title: "Доступность",
    desc: "Нейросети должны быть доступны каждому — без VPN, без зарубежных карт, без дорогих подписок. Мы убираем барьеры между пользователями в России и лучшими AI-технологиями мира.",
  },
  {
    icon: "M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    title: "Прозрачные цены",
    desc: "Per-token модель: вы платите только за использованные токены. Никаких скрытых комиссий, автосписаний и подписок. Стоимость каждого запроса видна сразу после ответа.",
  },
  {
  ...
  },
  {
    ...
    desc: "Чат, генерация картинок, видео, 3D, аудио, поиск в интернете, анализ документов, перевод и код — 50+ нейросетей в одном боте. Не нужно 10 разных подписок.",
  },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-text/60 text-lg max-w-2xl mx-auto leading-relaxed">
            Stone AI — российская платформа, которая объединяет 50+ AI-моделей от ведущих мировых компаний
            в одном удобном интерфейсе. Без VPN, без подписок, с оплатой из России.
          </p>
        </div>
