...
const stats = [
  ...
  { value: "320+", label: "пользователей", desc: "и растёт каждый день" },
];
...
const values = [
  {
    ...
    title: "Доступность",
    desc: "AI должен быть доступен каждому — с оплатой в рублях, без VPN. Одна подписка от 390₽/мес вместо десяти отдельных сервисов по $20 каждый.",
  },
  {
...
const timeline = [
  ...
  { year: "2026 Q1", event: "65+ моделей. Видео, 3D, аудио. Веб-чат stoneai.ru. API для разработчиков" },
...
const tools = [
  { icon: "💬", name: "AI Чат", desc: "65+ моделей в одном окне" },
    ...
    <div className="pt-28 pb-20 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-6">
            <img src="/mascots/stone-mascot-idle.png" alt="Stone AI маскот" width="120" height="120" className="mx-auto" />
          </div>
        </div>
        ...
        <section className="bg-gradient-to-r from-accent/10 to-teal/10 rounded-2xl border border-accent/10 p-8 md:p-12 text-center">
          <img src="/mascots/stone-mascot-chat.png" alt="Stone" width="80" height="80" className="mx-auto mb-4" />
