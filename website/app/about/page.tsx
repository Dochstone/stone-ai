...
const values = [
  ...
  },
  {
    ...
    desc: "4 понятных тарифа без скрытых комиссий и автопродлений. Free (10 запросов/день), Start (590₽), Pro (1 290₽), Elite (2 990₽). Pay-per-use для инструментов. Лимиты на подписках честно показаны на странице тарифов — никаких сюрпризов «вы превысили лимит, который мы вам не показали».",
  },
  {
