...
const faqItems = [
  ...
  { q: "Сколько стоит озвучка?", a: "TTS и STT включены в подписку Mini (390₽/мес) и выше. Количество озвучек зависит от тарифа: Mini — 3/мес, Max — 20/мес, Max Pro — 100/мес." },
...
export default function AudioPage() {
  return (
    <>
      ...
      <ToolCta title="Попробуйте AI Аудио" subtitle="Озвучка и голосовой ввод — прямо в чате." ctaHref="/studio" />
    </>
  );
}
