...
const faqItems = [
  ...
  { q: "Сколько стоит озвучка?", a: "TTS и STT включены в подписку Start (390₽/мес) и выше. Количество озвучек зависит от тарифа: Start — 3/мес, Pro — 20/мес, Elite — 100/мес." },
