  ...
  return (
    <div className="pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8 space-y-8 animate-fadeIn">
        ...
        {/* Form */}
        <div className="bg-bg rounded-2xl border border-text/5 p-6 sm:p-8 space-y-6">
          {/* Topic */}
          <div>
        ...
        {/* Loading state */}
        {loading && (
          <div className="bg-bg rounded-2xl border border-text/5 p-8 animate-fadeIn">
        ...
        {/* Preview */}
        {slides.length > 0 && !loading && (
          <div ref={previewRef} className="bg-bg rounded-2xl border border-text/5 p-6 sm:p-8 space-y-6 animate-fadeIn">
        ...
        <div className="space-y-4">
          ...
          {historyLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-bg rounded-2xl border border-text/5 p-5 animate-pulse">
            ...
            <div className="bg-bg rounded-2xl border border-text/5 p-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {history.map((item) => (
                <div
                  key={item.id}
                  className="bg-bg rounded-2xl border border-text/5 p-5 hover:border-text/10 transition-colors"
                >
