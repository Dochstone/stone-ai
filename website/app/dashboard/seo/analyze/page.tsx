        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <button onClick={analyze} disabled={loading || text.length < 100}
              ...
              {loading ? "Анализ..." : "Анализировать · 10₽"}
            </button>
          </div>
          ...
          <div className="bg-text/[0.02] border border-text/5 rounded-2xl p-5 min-h-[300px]">
            {result ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-text/15 text-sm">
                {loading ? <><img src="/mascots/stone-mascot-loading.webp?v=2" alt="" width="64" height="64" className="mb-2 opacity-60" />Анализ текста...</> : <><img src="/mascots/stone-mascot-idle.webp?v=2" alt="" width="64" height="64" className="mb-2 opacity-40" />Результат анализа появится здесь</>}
              </div>
            )}
          </div>
        </div>
