      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 sm:pt-8">
        ...
        <div className="bg-white rounded-2xl border border-text/5 p-5 mb-6">
          ...
          <button onClick={create} disabled={running || !niche.trim()}
            ...
            {running ? <><svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/></svg>Генерация...</> : "Создать кампанию (~99₽)"}
          </button>
        </div>
