...
const CATEGORY_FAQ: Record<string, { q: string; a: string }[]> = {
  chat: [
    { q: "Сколько запросов можно делать?", a: "Бесплатно (Pay-per-Use) — 10 быстрых + 2 премиум в день. На подписке Start — 600 быстрых + 90 премиум/мес, Pro — 1 500 быстрых + 112 премиум + 28 Opus/мес, Elite — 4 500 + 336 премиум + 56 Opus/мес + API." },
