...
const CATEGORY_FAQ: Record<string, { q: string; a: string }[]> = {
  chat: [
    { q: "Сколько запросов можно делать?", a: "Бесплатно — 15 запросов в день. На подписке Mini — 500/мес, Max — 2000/мес, Max Pro — 10000/мес." },
  ...
  video: [
    { q: "Как долго генерируется видео?", a: "От 10 до 60 секунд в зависимости от модели. Kling — самый быстрый." },
  ],
  reason: [
