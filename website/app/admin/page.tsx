...
function StatCard({ id, label, value, sub }: { id: string; label: string; value: string; sub?: string }) {
  ...
  return (
    <div className="bg-bg rounded-2xl border border-text/5 p-5 hover:shadow-md transition-shadow">
    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={login} className="bg-bg rounded-2xl border border-text/5 p-6 space-y-4 shadow-sm">
            <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {tab === "users" && !loading && (
          <div className="space-y-4 animate-fadeIn">
            {/* Filters */}
            <div className="bg-bg rounded-2xl border border-text/5 p-4">
        ...
        {tab === "transactions" && !loading && (
          <div className="bg-bg rounded-2xl border border-text/5 overflow-hidden animate-fadeIn">
            <div className="p-4 border-b border-text/5 flex items-center justify-between">
          ...
          <div className="space-y-4 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {promos.map((p: any) => {
                ...
                return (
                  <div key={p.code} className="bg-bg rounded-2xl border border-text/5 p-5 hover:shadow-md transition-shadow">
            ...
            {analytics && (
              <>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="bg-bg rounded-xl border border-text/5 p-4">
                ...
                {analytics.daily.length > 0 && (
                  <div className="bg-bg rounded-xl border border-text/5 p-5 mb-6">
                ...
                {analytics.referrers.length > 0 && (
                  <div className="bg-bg rounded-xl border border-text/5 p-5">
