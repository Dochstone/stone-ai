...
export const MODELS: AIModel[] = [
  ...
  { id: "deepseek-r1", name: "DeepSeek R1", company: "DeepSeek", tier: "pro", category: "chat", pricePerMillion: 6.0, context: "164K", description: "Reasoning-модель от DeepSeek. Показывает цепочку рассуждений. Конкурент o3 по 1/10 цены.", strengths: ["Reasoning", "Дешёвая", "Цепочка мыслей"] },
  ...
  { id: "claude-opus-4", name: "Claude Opus 4", company: "Anthropic", tier: "pro", category: "chat", pricePerMillion: 130.0, context: "200K", description: "Самая мощная модель Anthropic. 200К контекст, глубокое рассуждение. Идеальна для аналитики и исследований.", strengths: ["Самая мощная", "Аналитика", "200K контекст"] },
  ...
  { id: "gpt-5.4", name: "GPT-5.4", company: "OpenAI", tier: "pro", category: "chat", pricePerMillion: 30.0, context: "1M", description: "Новейший флагман OpenAI. 1М контекст, computer use, лучшая для кодинга и анализа.", strengths: ["1M контекст", "Computer Use", "Кодинг"] },
  { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", company: "Google", tier: "pro", category: "chat", pricePerMillion: 26.0, context: "1M", description: "Топовая модель Google. 1М контекст, мультимодальная, сильна в анализе данных.", strengths: ["1M контекст", "Мультимодальная", "Анализ данных"] },
  ...
  { id: "grok-3", name: "Grok 3", company: "xAI", tier: "pro", category: "chat", pricePerMillion: 36.0, context: "131K", description: "Флагман xAI. Прямые ответы без цензуры, сильное рассуждение. Для тех кто ценит честность.", strengths: ["Без цензуры", "Рассуждение", "Прямые ответы"] },
  ...
  { id: "nano-banana-pro", name: "Nano Banana Pro", company: "Google", tier: "pro", category: "image", pricePerMillion: 32.0, context: "65K", description: "Генерация изображений студийного качества от Google. Текст в картинках, 4K.", strengths: ["Студийное качество", "4K", "Текст в картинках"] },
  ...
  { id: "kling-v2", name: "Kling v2", company: "Kuaishou", tier: "pro", category: "video", pricePerMillion: 0.35, priceUnit: "/vid", context: "5-10s", description: "Генерация видео высокого качества. 5-10 секунд, реалистичное движение.", strengths: ["Высокое качество", "5-10с", "Реалистичное"] },
  { id: "runway-gen3", name: "Runway Gen-3", company: "Runway", tier: "pro", category: "video", pricePerMillion: 0.85, priceUnit: "/vid", context: "5-10s", description: "Кинематографическое качество от Runway. Сложные сцены и переходы.", strengths: ["Кинематографичное", "Сложные сцены", "5-10с"] },
  { id: "pika-2", name: "Pika 2.0", company: "Pika", tier: "pro", category: "video", pricePerMillion: 0.18, priceUnit: "/vid", context: "3-5s", description: "Быстрая и доступная генерация видео. Идеальна для коротких клипов.", strengths: ["Быстрая", "Дешёвая", "3-5с"] },
  { id: "stable-video", name: "Stable Video", company: "Stability", tier: "pro", category: "video", pricePerMillion: 0.15, priceUnit: "/vid", context: "4s", description: "Стабильное качество от Stability AI. 4 секунды, низкая цена.", strengths: ["Дешёвая", "Стабильная", "4с"] },
  { id: "luma-dream", name: "Luma Dream", company: "Luma", tier: "pro", category: "video", pricePerMillion: 0.50, priceUnit: "/vid", context: "5s", description: "Dream Machine от Luma. Плавные переходы и реалистичная физика.", strengths: ["Плавные переходы", "Физика", "5с"] },
