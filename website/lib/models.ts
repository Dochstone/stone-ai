...
export const MODELS: AIModel[] = [
  ...
  { id: "kling-v3", name: "Kling 3.0 Pro", company: "Kuaishou", tier: "pro", category: "video", pricePerMillion: 0.30, priceUnit: "/vid", context: "5-10s", description: "Топовая китайская видео-модель. Отличная детализация и реализм.", strengths: ["Реализм", "Детализация", "Pro"] },
  { id: "kling-v2", name: "Kling v2 Master", company: "Kuaishou", tier: "pro", category: "video", pricePerMillion: 0.25, priceUnit: "/vid", context: "5-10s", description: "Надёжная видео-модель второго поколения. Хороший баланс цена/качество.", strengths: ["Надёжная", "Доступная", "Баланс"] },
  // Mid-range
  { id: "luma-ray2", name: "Luma Ray 2", company: "Luma", tier: "pro", category: "video", pricePerMillion: 0.40, priceUnit: "/vid", context: "5-10s", description: "Новейшая модель от Luma. Кинематографичное качество, отличная физика и детализация.", strengths: ["Топ качество", "Физика", "Кинематографичное"] },
  { id: "luma-ray2-flash", name: "Ray 2 Flash", company: "Luma", tier: "pro", category: "video", pricePerMillion: 0.20, priceUnit: "/vid", context: "5s", description: "Быстрая версия Ray 2. Хорошее качество за секунды.", strengths: ["Быстрая", "Доступная", "5с"] },
  ...
  { id: "cogvideox", name: "CogVideoX", company: "Zhipu", tier: "pro", category: "video", pricePerMillion: 0.15, priceUnit: "/vid", context: "5s", description: "Модель от Zhipu AI. Хорошая детализация и плавные движения.", strengths: ["Детализация", "Плавное", "Бюджетная"] },
  { id: "mochi", name: "Mochi 1", company: "Genmo", tier: "pro", category: "video", pricePerMillion: 0.15, priceUnit: "/vid", context: "5s", description: "Open source модель от Genmo. Стилизованные и креативные видео.", strengths: ["Open source", "Креативная", "Стилизация"] },
