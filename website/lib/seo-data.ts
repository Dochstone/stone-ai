...
export const PROFESSIONS: Profession[] = [
  ...
  },
  {
    ...
    intro: "Stone AI даёт 15 бесплатных запросов в день к 8 моделям. Помощь с рефератами, курсовыми, подготовкой к экзаменам, переводом — без регистрации. AI не пишет за вас, а объясняет материал, проверяет решения и помогает разобраться в сложных темах.",
    tasks: [
