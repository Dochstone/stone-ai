...
export const COMPARISONS: Comparison[] = [
  ...
  // ─── Platform comparisons ───
  {
    ...
    verdict: "Stone AI: 65+ нейросетей (GPT, Claude, Gemini, Llama и др.) от 390₽/мес. ChatGPT Plus: только модели OpenAI за $20/мес (~1900₽). Stone AI выгоднее в 5 раз, даёт доступ ко всем провайдерам, генерацию картинок, видео, SEO-инструменты — всё в одном.",
    useCases: { model1: ["65+ нейросетей от всех провайдеров", "От 390₽/мес (в 5 раз дешевле)", "Картинки, видео, 3D, SEO", "Работает без VPN из России", "Telegram-бот + веб-чат"], model2: ["Только модели OpenAI", "$20/мес (~1900₽)", "Нет генерации видео", "Нужен VPN из России", "Только веб-интерфейс"] },
    platform1: { name: "Stone AI", desc: "AI-студия нового поколения. 65+ нейросетей от всех провайдеров в одном интерфейсе.", logo: "/mascots/stone-mascot-idle.webp", stats: [{ label: "Моделей", value: "65+" }, { label: "Цена", value: "от 390₽" }, { label: "Инструменты", value: "15+" }] },
  ...
  },
  {
    ...
    useCases: { model1: ["65+ нейросетей + Perplexity Sonar", "Чат + картинки + видео + SEO", "От 390₽/мес за всё", "Без VPN из России"], model2: ["Только поиск в интернете", "Цитирование источников", "$20/мес за Pro", "Нет генерации контента"] },
    platform1: { name: "Stone AI", desc: "AI-студия: чат, картинки, видео, SEO. 65+ нейросетей включая Perplexity Sonar.", logo: "/mascots/stone-mascot-idle.webp", stats: [{ label: "Моделей", value: "65+" }, { label: "Цена", value: "от 390₽" }, { label: "Возможности", value: "Всё" }] },
