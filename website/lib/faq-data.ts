export const homeFaqData = [
  ...
  },
  {
    ...
    a: '4 тарифа на <a href="/pricing" class="text-accent hover:underline font-semibold">странице цен</a>: <strong>Free</strong> — 15 запросов/день бесплатно. <strong>Start (390₽/мес)</strong> — 20+ моделей, 500 запросов, включая GPT-5.1 и Claude Sonnet. <strong>Pro (890₽/мес)</strong> — все 65+ моделей без ограничений, 2000 запросов, 50 картинок, 10 видео. <strong>Elite (1990₽/мес)</strong> — 10 000 запросов, API доступ, приоритет. Инструменты панели оплачиваются с баланса: шаблоны от 10₽, SEO-статьи 15₽, презентации 40₽, фотосессия 15-40₽, рекламные кампании 99₽. При регистрации бонус ~95₽ на баланс.',
  },
  {
  ...
  },
  {
    ...
    a: 'Бесплатно доступны 7 моделей: GPT-4o mini (OpenAI), Claude Haiku 4.5 (Anthropic), Gemini 2.0 Flash (Google), DeepSeek V3, Llama 4 Maverick (Meta), Mistral Large и Nano Banana (генерация картинок). 15 запросов в день + 2 картинки. Полный список всех 65+ моделей — на <a href="/models" class="text-accent hover:underline font-semibold">странице моделей</a>. <a href="/dashboard/bots" class="text-accent hover:underline">Конструктор ботов</a> и <a href="/dashboard/agent" class="text-accent hover:underline">AI-агент</a> также доступны на бесплатном тарифе.',
  },
  {
  ...
  },
  {
    ...
    a: 'В разделе <a href="/dashboard/achievements" class="text-accent hover:underline font-semibold">достижения</a> отслеживается прогресс: первая картинка (+10₽), 10 генераций (+20₽), первое видео (+15₽) и другие — всего 15+ ачивок. Бонусы начисляются на баланс при выполнении. В разделе <a href="/dashboard/games" class="text-accent hover:underline font-semibold">игры</a> — Змейка и 2048 с таблицей лидеров. Топ-5 игроков каждого месяца получают +100₽ на баланс. Игры также появляются во время ожидания генерации видео/картинок.',
  },
  {
