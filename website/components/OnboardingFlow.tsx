...
const USER_STEPS: Step[] = [
  ...
  { mascot: `${M}chat.png`, title: "Чат бесплатный — 10 запросов в день", desc: "Выбирай модель в меню слева. GPT-4o, Claude, Gemini и другие — каждая со своей суперсилой.", highlight: "[data-onboard='model-picker']" },
