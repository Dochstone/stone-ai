                ...
                {TOOLS.map((t) => {
                  ...
                  return (
                    <a
                      key={t.name}
                      href={t.href}
                      className="tile-hover group flex flex-col items-center justify-center min-h-[100px] bg-text/[0.03] rounded-xl p-3 text-center border border-transparent focus:outline-none focus:ring-2 focus:ring-accent/30"
                      style={{ ["--pad-c" as string]: t.color }}
                    >
                      <span className="glass-pad tile-icon flex items-center justify-center w-10 h-10 rounded-xl mb-1.5">
