...
export const PROVIDER_STYLES: Record<string, ProviderStyle> = {
  OpenAI:     { gradient: "linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%)",       color: "#10a37f", letter: "G",  logo: "/logos/openai.svg",    icon: "/logos/openai-icon.png",    darkBg: true },
  Anthropic:  { gradient: "linear-gradient(135deg, #D4845A 0%, #C4623D 100%)",       color: "#d97706", letter: "C",  logo: "/logos/anthropic.svg", icon: "/logos/claude-icon.png", darkBg: true },
