      ...
      {confirming ? (
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            className="flex-1 text-[11px] font-semibold text-white bg-red-500 hover:bg-red-600 py-2 rounded-lg transition-colors"
          >
            Да, удалить
          </button>
          <button
            onClick={() => setConfirming(false)}
            className="flex-1 text-[11px] font-semibold text-text/40 bg-text/[0.06] hover:bg-text/[0.10] py-2 rounded-lg transition-colors"
          >
            Отмена
          </button>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 text-[11px] text-text/25 hover:text-red-400 py-2 rounded-lg hover:bg-red-500/5 transition-colors"
        >
