          ...
          <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
            <div className={`max-w-[85%] rounded-xl px-3.5 py-2.5 text-[13px] leading-relaxed ${
              ...
              {m.role === "assistant" && m.content === "REGISTER_CTA" ? (
                <span>Бесплатные запросы закончились. <a href="/profile" className="text-accent font-bold hover:underline">Зарегистрируйтесь</a> — 10 запросов/день бесплатно.</span>
              ) : (
