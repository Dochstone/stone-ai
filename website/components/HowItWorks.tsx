...
const steps = [
  ...
  },
  {
    ...
    desc: `От ${planPriceFull("mini")} — 65+ нейросетей, картинки, видео, 3D. Карта РФ, СБП, криптовалюта.`,
  },
];
  ...
  return (
    <section className="py-20 md:py-28 bg-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <img src="/mascots/stone-mascot-success.webp?v=2" alt="Stone AI" width="64" height="64" loading="lazy" className="mx-auto mb-4" />
