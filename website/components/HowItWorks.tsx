const steps = [
  ...
  },
  {
    ...
    desc: "От 390₽/мес — 65+ нейросетей, картинки, видео, 3D. Карта РФ, СБП, криптовалюта.",
  },
];
  ...
  return (
    <section className="py-20 md:py-28 bg-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <img src="/mascots/stone-mascot-success.png" alt="" width="64" height="64" className="mx-auto mb-4" />
