...
function TrustMarquee() {
  const logos = (
    <>
      ...
      {/* xAI */}
      <ProviderLogo>
        <svg className="h-5 shrink-0" viewBox="0 0 24 24" fill="#1A1916"><path d="M3 3l7.5 9L3 21h2.5l6-7.2L17.5 21H21l-7.5-9L21 3h-2.5l-6 7.2L6.5 3H3z"/></svg>
        <span style={{ fontSize: 18, fontWeight: 800, fontStyle: "italic", color: "#1A1916" }}>xAI</span>
      </ProviderLogo>
      {/* DeepSeek */}
      <ProviderLogo>
        <span style={{ fontSize: 20, fontWeight: 700, color: "#0891B2" }}>DeepSeek</span>
      </ProviderLogo>
      {/* Meta — official infinity */}
      <ProviderLogo>
        <svg className="h-7 shrink-0" viewBox="0 0 36 16" fill="none"><path d="M8 1.5C4.5 1.5 1.5 5 1.5 8s3 6.5 6.5 6.5c2 0 3.5-1 5-3l3-4.5c1.5-2 3-3 5-3 3.5 0 6.5 3 6.5 6.5S27.5 17 24 17c-2 0-3.5-1-5-3l-3-4.5C14.5 7 13 6 11 6 7.5 6 4.5 9 4.5 12.5" stroke="#0668E1" strokeWidth="2.5" strokeLinecap="round"/></svg>
        <span style={{ fontSize: 18, fontWeight: 700, color: "#0668E1" }}>Meta</span>
      </ProviderLogo>
      {/* Mistral — official pixel blocks */}
      <ProviderLogo>
      ...
      {/* Runway */}
      <ProviderLogo>
        <span style={{ fontSize: 20, fontWeight: 800, color: "#1A1916", letterSpacing: "-0.02em" }}>Runway</span>
      </ProviderLogo>
      {/* ElevenLabs */}
      <ProviderLogo>
        <span style={{ fontSize: 18, fontWeight: 600, color: "#1A1916" }}>ElevenLabs</span>
      </ProviderLogo>
    </>
  );
