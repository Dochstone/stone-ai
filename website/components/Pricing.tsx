...
const plans = PRICING_PLANS; /*
  ...
  },
  {
    ...
    features: ["Все 65+ нейросетей включая Opus", "1 500 запросов к быстрым моделям", "28 премиум + 7 Opus в неделю", "35 картинок + 7 видео в неделю", "5 3D-моделей и 20 озвучек", "Голосовой ассистент"],
    locked: [],
  ...
  },
  {
    ...
    features: ["Все 65+ нейросетей + доступ к API", "4 500 запросов к быстрым моделям", "84 премиум + 14 Opus в неделю", "70 картинок + 21 видео в неделю", "30 3D-моделей и 100 озвучек", "Приоритетная скорость ответов", "Ранний доступ к новым моделям"],
    locked: [],
