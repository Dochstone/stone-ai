...
const plans = [
  {
    ...
    features: ["10 бесплатных чат-запросов/день", "8 бесплатных моделей", "2 картинки + 1 видео в день", "AI-шаблоны от 3₽", "Презентации, SEO, кампании — с баланса", "Бонус 100₽ при регистрации"],
    locked: [],
