...
const plans = [
  ...
  },
  {
    ...
    features: ["20+ моделей включая GPT-5.1 и Claude Sonnet", "1 500 запросов к быстрым моделям", "90 запросов к премиум моделям", "50 картинок и 15 видео в месяц", "Все инструменты со скидкой"],
  ...
  },
  {
    ...
    features: ["Все 65+ моделей включая Opus", "2 100 запросов к быстрым моделям", "120 запросов к премиум (30 к Opus)", "150 картинок и 30 видео в месяц", "5 3D-моделей и 20 озвучек", "Голосовой ассистент"],
    locked: [],
  ...
  },
  {
    ...
    features: ["Все 65+ моделей + доступ к API", "10 500 запросов к быстрым моделям", "540 запросов к премиум (90 к Opus)", "300 картинок и 60 видео в месяц", "30 3D-моделей и 100 озвучек", "Приоритетная скорость ответов", "Ранний доступ к новым моделям"],
    locked: [],
