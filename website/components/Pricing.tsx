...
const plans = [
  {
    ...
    features: ["10 бесплатных чат-запросов/день", "8 бесплатных моделей", "2 картинки + 1 видео (Veo 3) навсегда", "AI-шаблоны от 3₽", "Презентации, SEO, кампании — с баланса", "Бонус 100₽ при регистрации"],
    locked: [],
  ...
  },
  {
    ...
    features: ["20+ моделей включая GPT-5.1 и Claude Sonnet", "600 запросов к быстрым моделям", "90 запросов к премиум моделям", "60 картинок и 30 видео в месяц", "Все инструменты со скидкой"],
    locked: ["Claude Opus", "3D модели"],
    cta: "Выбрать Start", icon: "⚡", color: "#22D3EE", img: "/plan-mini.jpg?v=2",
  },
  {
    id: "max", name: "Pro", price: "1\u00A0290₽", oldPrice: "1\u00A0890₽", priceNum: 1290, premium: false, period: "/мес", desc: "Все 65+ моделей",
    badge: "Популярный", accent: true,
    features: ["Все 65+ моделей включая Opus", "1 500 запросов к быстрым моделям", "120 запросов к премиум (30 к Opus)", "150 картинок и 30 видео в месяц", "5 3D-моделей и 20 озвучек", "Голосовой ассистент"],
    locked: [],
    cta: "Выбрать Pro", icon: "🔥", color: "#A855F7", img: "/plan-max.jpg?v=2",
  },
  {
    id: "max-pro", name: "Elite", price: "2\u00A0990₽", oldPrice: "4\u00A0490₽", priceNum: 2990, premium: true, period: "/мес", desc: "Максимум возможностей",
    badge: "Легенда", accent: false,
    features: ["Все 65+ моделей + доступ к API", "4 500 запросов к быстрым моделям", "360 запросов к премиум (60 к Opus)", "300 картинок и 90 видео в месяц", "30 3D-моделей и 100 озвучек", "Приоритетная скорость ответов", "Ранний доступ к новым моделям"],
    locked: [],
