...
const plans = [
  ...
  {
    id: "max", name: "Pro", price: "1\u00A0290₽", oldPrice: "1\u00A0890₽", priceNum: 1290, premium: false, period: "/мес", desc: "Все 65+ нейросетей",
    badge: "Популярный", accent: true,
    features: ["Все 65+ нейросетей включая Opus", "1 500 запросов к быстрым моделям", "120 запросов к премиум (30 к Opus)", "150 картинок и 30 видео в месяц", "5 3D-моделей и 20 озвучек", "Голосовой ассистент"],
    locked: [],
  ...
  },
  {
    ...
    features: ["Все 65+ нейросетей + доступ к API", "4 500 запросов к быстрым моделям", "360 запросов к премиум (60 к Opus)", "300 картинок и 90 видео в месяц", "30 3D-моделей и 100 озвучек", "Приоритетная скорость ответов", "Ранний доступ к новым моделям"],
    locked: [],
