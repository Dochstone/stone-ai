...
const plans = [
  {
    ...
    features: ["15 бесплатных чат-запросов/день", "8 бесплатных моделей", "2 картинки + 1 видео (Veo 3) навсегда", "AI-шаблоны от 3₽", "Презентации, SEO, кампании — с баланса", "Бонус 100₽ при регистрации"],
    locked: [],
  ...
  },
  {
    ...
    features: ["20+ моделей включая GPT-5.1 и Claude Sonnet", "900 запросов к быстрым моделям", "90 запросов к премиум моделям", "60 картинок и 30 видео в месяц", "Все инструменты со скидкой"],
