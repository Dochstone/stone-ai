...
const STEPS = [
  {
    ...
    desc: "Нажмите на бургер-меню (мобильный) или посмотрите список слева. 65+ нейросетей, бесплатные отмечены FREE.",
    icon: "🧠",
  },
  {
    title: "Пишите в чат",
  ...
  },
  {
    ...
    desc: "Вверху справа — ваш баланс в рублях. Нажмите, чтобы пополнить. 10 запросов в день бесплатно!",
    icon: "💳",
  },
  {
    title: "Готово!",
