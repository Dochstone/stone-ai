    ...
    <div>
      ...
      <div className="flex items-center gap-2 mt-2 flex-wrap">
        <button
          ...
          className="flex items-center gap-1.5 text-[11px] font-semibold text-accent bg-accent/8 hover:bg-accent/15 px-3 py-1.5 rounded-full transition-colors"
        >
        ...
        <button onClick={shareTG} className="flex items-center gap-1.5 text-[11px] font-semibold text-[#2AABEE] bg-[#2AABEE]/8 hover:bg-[#2AABEE]/15 px-3 py-1.5 rounded-full transition-colors" title="Поделиться в Telegram">
        ...
        <button onClick={shareVK} className="flex items-center gap-1.5 text-[11px] font-semibold text-[#4680C2] bg-[#4680C2]/8 hover:bg-[#4680C2]/15 px-3 py-1.5 rounded-full transition-colors" title="Поделиться в VK">
        ...
        <button onClick={copyLink} className={`flex items-center gap-1.5 text-[11px] font-semibold px-3 py-1.5 rounded-full transition-colors ${copied ? "text-teal bg-teal/10" : "text-text/40 bg-text/5 hover:bg-text/10"}`} title="Копировать ссылку">
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
