    ...
    <div className="relative shrink-0">
      ...
      {!avatarUrl && (
        <a
          ...
          className="absolute -bottom-0.5 -right-0.5 w-6 h-6 rounded-full bg-accent border-2 border-bg flex items-center justify-center hover:scale-110 transition-transform"
        >
