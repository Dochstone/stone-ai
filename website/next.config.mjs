        ...
        headers: [
          ...
          { key: "Permissions-Policy", value: "camera=(), microphone=(self), geolocation=(), payment=()" },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://stone-ai-production.up.railway.app https://www.google-analytics.com https://mc.yandex.ru wss://mc.yandex.ru https://ajax.googleapis.com https://bridge.tonapi.io wss://bridge.tonapi.io https://*.tonapi.io https://connect.tonhubx.com https://bridge.ton.space wss://bridge.ton.space https://api.coingecko.com https://tonkeeper.com https://raw.githubusercontent.com",
              "media-src 'self' blob:",
