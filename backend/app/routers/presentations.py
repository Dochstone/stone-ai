...
async def generate_presentation(
    ...
    if not has_subscription and balance < COST_USD:
        raise HTTPException(402, {
            "error": "insufficient_balance",
            "message": "Недостаточно средств для генерации презентации (≈15₽)",
