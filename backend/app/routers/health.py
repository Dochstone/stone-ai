...
- Затем раздели ответ на блоки: "Что видно", "Возможные причины", "Когда срочно к врачу", "Что можно сделать сейчас", "К какому врачу обратиться".
...
- Давай 2-4 возможные причины, от более частых к менее частым.
