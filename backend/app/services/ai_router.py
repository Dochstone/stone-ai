...
MODELS_REGISTRY = [
    ...
    {"id": "gemini-2.0-flash", "name": "Gemini 2.0 Flash",  "company": "Google",    "tier": 1, "openrouter_id": "google/gemini-2.0-flash-001",        "icon": "💎", "desc": "Скоростной",           "category": "chat",   "context_length": "1M",   "price_input": 0.50,  "price_output": 2.00,   "price_weighted": 1.40,   "active": True},
    ...
    {"id": "gemini-3.1-pro-preview", "name": "Gemini 3.1 Pro Preview", "company": "Google", "tier": 3, "openrouter_id": "google/gemini-3.1-pro-preview", "icon": "💎", "desc": "Новый мультимодальный флагман", "category": "chat", "context_length": "1M", "price_input": 6.50, "price_output": 39.00, "price_weighted": 26.10, "active": True},
