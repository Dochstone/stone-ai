...
MODELS_REGISTRY = [
    ...
    {"id": "gemini-2.5-pro",   "name": "Gemini 2.5 Pro",    "company": "Google",    "tier": 3, "openrouter_id": "google/gemini-2.5-pro",          "icon": "🔮", "desc": "Мультимодальный",      "category": "reason", "context_length": "1M",   "price_input": 5.00,  "price_output": 40.00,  "price_weighted": 26.00,  "active": True},
