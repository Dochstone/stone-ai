...
# Upgrade messages
_UPGRADE_MESSAGES = {
    "limit_hit": "Лимит на сегодня исчерпан. Обновление через {hours}ч. Перейдите на тариф Start за 590₽/мес",
    "image_limit": "Лимит {limit} изображений на сегодня. Перейдите на тариф Start за 590₽/мес",
    "model_locked": "{model_name} доступен на тарифе Start (590₽/мес)",
