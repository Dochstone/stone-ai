...
# Upgrade messages
_UPGRADE_MESSAGES = {
    "limit_hit": "Лимит на сегодня исчерпан. Обновление через {hours}ч. Перейдите на тариф Мини за 390₽/мес",
    "image_limit": "Лимит {limit} изображений на сегодня. Перейдите на тариф Мини за 390₽/мес",
    "model_locked": "{model_name} доступен на тарифе Мини (390₽/мес)",
